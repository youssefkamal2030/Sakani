        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CollegeName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    NumberOfRooms = table.Column<int>(type: "int", nullable: false),
                    NumberOfBeds = table.Column<int>(type: "int", nullable: false),
                    IsWifi = table.Column<bool>(type: "bit", nullable: true),
                    OwnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_Apartments_ApartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    stuendtId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_Students_stuendtId",
                        column: x => x.stuendtId,
                        principalTable: "Students",
                        principalColumn: "StudentId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_stuendtId",
                table: "Bookings",
                column: "stuendtId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_ApartmentId",
                table: "Feedbacks",
                column: "ApartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_VerificationStatus",
                table: "Owners",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_CollegeName",
                table: "Students",
                column: "CollegeName");

            migrationBuilder.CreateIndex(
                name: "IX_Students_Origin",
                table: "Students",
                column: "Origin");
